...
## Second-run batch provenance notes

The second-run microstructure source used the official arXiv API endpoint `https://export.arxiv.org/api/query` with a q-fin.MF query covering market microstructure, order flow, limit-order books, price discovery, and liquidity. Batch 001 retrieved 150 records from an API total of 434 with retrieval snapshot hash `0d82f381b232ff24d8464ce02f0434ecae2899416688e7bd4c288921567db6f6`; batch 006 retrieved the next 150-record slice with retrieval snapshot hash `21a3afb9a4dd060820a6dc378bdad837bb7f17bbaae1d9294a0cd81325abc067`. The source endpoint is used for metadata leads only; no market data or executable rules are inferred.

The systematic academic source used the same official arXiv API with q-fin.ST/TR/RM terms for statistical arbitrage, pairs, cointegration, momentum, trend following, volatility, and carry. The API total was 1,984; batch 004 used start 0 with snapshot hash `515e2e927ba1b4a6f00139cc903f5ac38193780ba4f9b03812eb4a928497fda2`, and batch 005 used start 150 with snapshot hash `8a24a5d864e3190bea0d3b11ce407323a71c081e512b0add30616cf924660d61`.
