...
def main() -> None:
    ...
    assert package['package_id'] == 'freqtrade_batch_001_engine_fidelity_measurement_freeze_v2_3'
    ...
    assert package['measurement_boundary']['next_status_if_validated'] == 'V2_3_VALIDATED_REQUEST_MEASUREMENT_APPROVAL'
    ...
    assert state == {'ledger_n': 898, 'last_sequence': 898, 'ledger_canonical_sha256': EXPECTED_LEDGER_CANONICAL, 'v2_package_sha256': EXPECTED_V2, 'v2_1_package_sha256': EXPECTED_V2_1, 'v2_2_package_sha256': EXPECTED_V2_2, 'acquisition_manifest_canonical_sha256': EXPECTED_ACQ_CANONICAL, 'starting_commit': 'ed2caaab1bdd6a20b1185c79a5f257c8d68927bf'}
