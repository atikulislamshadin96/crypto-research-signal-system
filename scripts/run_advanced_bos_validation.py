...
def main() -> None:
    ...
    output = Path(config["system"]["output_dir"]) / "advanced_bos_extension"
    ...
    for symbol in SYMBOLS:
        csv_path = DATA_ROOT / symbol / f"{symbol}-{TIMEFRAME}-2020-2026-08-17.csv"
        ...
        path = output / f"{symbol}-{TIMEFRAME}-advanced-validation.json"
